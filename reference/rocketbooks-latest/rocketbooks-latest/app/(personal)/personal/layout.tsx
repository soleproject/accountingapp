...
import { PersonalAssistantRegistrar } from './_components/PersonalAssistantRegistrar';
...
export default async function PersonalLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <AssistantProvider>
      <PersonalAssistantRegistrar />
      <div className="flex min-h-screen bg-zinc-50 dark:bg-zinc-950">
        <PersonalSidebar workspaces={workspaces} permissions={permissions} branding={branding} />
