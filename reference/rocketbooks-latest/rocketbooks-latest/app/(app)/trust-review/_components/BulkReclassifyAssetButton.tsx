...
export function BulkReclassifyAssetButton({ findingIds, expenseAccounts, onComplete, onPendingChange }: Props) {
	...
	const submit = () => {
		...
		startTransition(async () => {
			const r = await bulkReclassifyAsset({ findingIds, expenseAccountId: pickedId });
	...
	return (
		<>
			...
			>
				↪ Move {findingIds.length} to expense
			</button>
			{open && (
