...
export function ConnectBankButton() {
  ...
  const onSuccess = useCallback(
    async (publicToken: string, metadata: { institution: { name: string; institution_id: string } | null; accounts: Array<{ id: string; name: string; mask: string; subtype: string; type: string }> }) => {
      try {
