...
SEMANTIC_TO_CODE: dict[str, dict[str, str]] = {
    ...
    "automotive": {  # vehicle repair/maintenance/registration (distinct from fuel + transportation)
        "professional_services": "6250",
        "restaurant": "6250",
        "ecommerce": "6250",
        "construction": "6250",
        "generic": "6250",
    },
    "equipment": {  # small equipment / tools (§179 short-lived)
        "professional_services": "6600",
        "restaurant": "6600",
        "ecommerce": "6600",
        "construction": "6300",
    ...
    "job_supplies": {  # construction/trade job materials — not restaurant COGS
    ...
    "interest_expense": {  # loan/credit interest paid
        "professional_services": "6850",
        "restaurant": "6850",
        "ecommerce": "6850",
        "construction": "6850",
        "generic": "6850",
    },
    "sales_refunds": {  # contra-revenue
    ...
    "owner_contribution": {  # owner capital in
        "professional_services": "3200",
        "restaurant": "3200",
        "ecommerce": "3200",
        "construction": "3200",
        "generic": "3200",
...
SEMANTIC_TO_NAME_PATTERNS: dict[str, list[str]] = {
    ...
    "insurance":             ["insurance"],
    "automotive":            ["automotive", "auto expense", "auto repair", "vehicle expense", "vehicle maintenance", "car expense"],
    "equipment":             ["equipment", "tools", "small tools"],
    "job_supplies":          ["job supplies", "jobsite supplies", "job site supplies", "construction supplies", "trade supplies"],
    "interest_expense":      ["interest expense", "interest paid", "loan interest", "finance charge"],
    "sales_refunds":         ["refunds & returns", "refunds", "returns", "sales returns", "chargebacks"],
    "owner_contribution":    ["owner's contribution", "owner contribution", "capital contribution", "paid-in capital", "shareholder contribution"],
